...
export const IconPlus: FC<IconPlusProps> = ({ onClick }) => {
    return (
...
export const IconMinus: FC<IconMinusProps> = ({ onClick }) => {
    return (
        <IconStyled onClick={onClick}>
            <svg width="24" height="24" viewBox="0 0 24 24">
...
export const IconDelete: FC<IconDeleteProps> = ({ onClick }) => {
    return (
        <IconStyled onClick={onClick}>
            <svg style={{ transform: 'scale(1.3)' }} width="24" height="24" viewBox="0 0 24 24">
